...
<form:form modelAttribute="mxjad" action="/mxjad.do" method="post">
	...
	<input type="hidden" name="sn" value="${mxjad.sn }" />
	...
	<table width="100%">
		...
		<tr>
			<th>手机图片：</th>
			<td >
				<f:img id="phonePicFileSn_img" hid="phonePicFileSn" hname="phonePicFileSn" width="120" height="120" src="${mxjad.phonePicFileSn}" preview="true"/><br>
		...
		<tr>
			<th>Pad图片：</th>
			<td >
				<f:img id="padPicFileSn_img" hid="padPicFileSn" hname="padPicFileSn" width="120" height="120" src="${mxjad.padPicFileSn}" preview="true"/><br>
