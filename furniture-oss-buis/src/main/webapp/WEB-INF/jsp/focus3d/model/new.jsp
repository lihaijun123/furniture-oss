...
<form:form modelAttribute="modelInfo" action="/modelInfo.do" method="post">
    ...
    <table width="100%">
        <caption class="x-panel-header">添加模型</caption>
        <tr>
    ...
    <table id="tb_1">
        ...
        <tr>
            <th><font color="red">*</font>名称：</th>
            <td><input type="text" name="modelContentInfoList[0].name" value="${modelContentInfoList[0].name}"/></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <f:img id="fileSn_0_img" hid="fileSn_0" hname="modelContentInfoList[0].fileSn" width="120" height="120"
                       src="${modelContentInfoList[0].fileSn}"/><br>
    ...
    <table id="tb_2">
        ...
        <tr>
            <th><font color="red">*</font>名称：</th>
            <td><input type="text" name="modelContentInfoList[1].name" value="${modelContentInfoList[1].name}"/></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <f:img id="fileSn_1_img" hid="fileSn_1" hname="modelContentInfoList[1].fileSn" width="120" height="120"
                       src="${modelContentInfoList[1].fileSn}"/><br>
    ...
    <table id="tb_3">
        ...
        <tr>
            <th><font color="red">*</font>名称：</th>
            <td><input type="text" name="modelContentInfoList[2].name" value="${modelContentInfoList[2].name}"/></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <f:img id="fileSn_2_img" hid="fileSn_2" hname="modelContentInfoList[2].fileSn" width="120" height="120"
                       src="${modelContentInfoList[2].fileSn}"/><br>
    ...
    <table  id="tb_4">
        ...
        <tr>
            <th><font color="red">*</font>名称：</th>
            <td><input type="text" name="modelContentInfoList[3].name" value="${modelContentInfoList[3].name}"/></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <f:img id="fileSn_3_img" hid="fileSn_3" hname="modelContentInfoList[3].fileSn" width="120" height="120"
                       src="${modelContentInfoList[3].fileSn}"/><br>
    ...
    <table id="tb_5">
        ...
        <tr>
            <th><font color="red">*</font>名称：</th>
            <td><input type="text" name="modelContentInfoList[4].name" value="${modelContentInfoList[4].name}"/></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <f:img id="fileSn_4_img" hid="fileSn_4" hname="modelContentInfoList[4].fileSn" width="120" height="120"
                       src="${modelContentInfoList[4].fileSn}"/><br>
