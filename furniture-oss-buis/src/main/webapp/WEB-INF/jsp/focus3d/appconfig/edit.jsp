	...
	<div class="panel panel-default">
	   ...
	   <div class="panel-body">
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
		      	<input type="text" class="form-control" id="keyName" name="keyName" value="${appConfig.keyName }" placeholder="请输入名字">
		      </div>
		   </div>
		   ...
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
				<select class="form-control" name="type">
						...
						<option value="1" ${appConfig.type eq 1 ? "selected='selected'" : ""}>汉语拼音</option>
						<option value="2" ${appConfig.type eq 2 ? "selected='selected'" : ""}>遨游星空</option>
						<option value="3" ${appConfig.type eq 3 ? "selected='selected'" : ""}>科学常识</option>
						<option value="4" ${appConfig.type eq 4 ? "selected='selected'" : ""}>我的祖国</option>
						<option value="5" ${appConfig.type eq 5 ? "selected='selected'" : ""}>自我保护</option>
				</select>
		      </div>
		   </div>
		    -->
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
		      	<textarea class="form-control" id="remark" name="remark" rows="3">${appConfig.remark }</textarea>
		      </div>
		   </div>
	   </div>
	</div>
				...
				<div class="col-md-6">
					<label class="checkbox-inline">
				      <input type="radio" name="configGetType" id="configGetType"
				         value="1" ${appConfig.configGetType eq 1 ? "checked" : "" }>本地
				   </label>
				   <label class="checkbox-inline">
				      <input type="radio" name="configGetType" id="configGetType"
				         value="2" ${appConfig.configGetType eq 2 ? "checked" : "" }>阿里云
				   </label>
				</div>
			</div>
	   </div>
