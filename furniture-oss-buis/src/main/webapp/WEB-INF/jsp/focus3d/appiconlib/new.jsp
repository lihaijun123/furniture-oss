...
<form:form modelAttribute="appIconLib" action="/appiconlib.do" method="post">
	...
	<table width="100%">
		<caption class="x-panel-header">添加app图标库</caption>
		<tr>
		...
		<tr>
			...
			<td >
				<f:img id="imageFileSn_img" hid="imageFileSn" hname="imageFileSn" width="120" height="120" dsrc="/js/uploadFile/pic120.gif" />
				<br>
		...
		<tr>
			<th>图片标识：</th>
			<td ><form:input path="imageKey"/><form:errors path="imageKey" cssClass="errors" /><font color="red">&nbsp;</font></td>
		</tr>
