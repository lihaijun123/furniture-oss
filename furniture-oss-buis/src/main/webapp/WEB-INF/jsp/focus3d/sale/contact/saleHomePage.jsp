...
<html>
	...
	<body>
	<div id ="modules" style = "width:50%;right:0%;left:0%">
		...
		<tbody>
			...
			<c:forEach var="line" items="${contactPlanList}" varStatus="status" end ="2">
			<tr>
				<td nowrap style="overflow:hidden;text-overflow:ellipsis"  width="25%"><a onclick="activateCenterPage();" href = "/sale/customer.do?method=edit&sn=${line.customerSn}&list=home" target="centerPage">${line.customerName }</a></td>
			...
			<tr>
			<td align = "right" colSpan = "4"><a onclick="activateCenterPage();"  href = "/sale/contact.do?method=planlistAll" target="centerPage">查看更多>>...</a></td>
			</tr>
		</tbody>
	</table>
	</div>
