...
<table width="100%">
<caption class="x-panel-header">添加业务联系记录</caption>
	<tr>
		<th>客户名称：</th>
		<td >
		...
		<form:hidden path="parentContactSn"/>
	</tr>
	<tr>
		<th>联系时间：</th>
		<td>
		<input id = "contactTime" type="text" value="${contact.contactTime}" name="contactTime" onclick="show(this,'yyyy-MM-dd')" readonly = false />
		</td>
	</tr>
	<tr>
		<th>联系内容：</th>
...
<div class="buttons">
		...
		<input type="button" value="关闭"  class="submitc"
					onclick="javasctript:closeWin()">
	</div>
</form:form>
</body>
