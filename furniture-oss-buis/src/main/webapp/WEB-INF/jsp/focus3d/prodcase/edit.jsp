...
<%@page import="com.focustech.focus3d.model.prodcase.ProdCaseFileContent"%>
<%@page import="com.focustech.focus3d.model.prodcase.ProdCaseFile"%>
<%@page import="com.focustech.focus3d.model.prodcase.ProdCase"%>
...
<form:form modelAttribute="prodCase" action="/prodcase.do" method="post">
	...
	<form:hidden path="sn"/>
	<table width="100%">
		<caption class="x-panel-header">视频案例修改</caption>
		<tr>
		...
		<tr>
			...
			<td >
				<f:img id="imageFileSn_img" hname="imageFileSn" hid="imageFileSn" width="120" height="120" src="${prodCase.imageFileSn}" /><br>
	...
	<table>
			...
			<form:hidden path="caseFile.sn"/>
			<tr>
				<th><font color="red">*</font>名称：</th>
				<td ><form:input path="caseFile.fileName"/></td>
			</tr>
		...
		<tr>
			...
			<td>
				...
				<f:fileInfo id="fileSn_namedisplay" hid="fileSn" hname="caseFile.fileSn" value="${prodCase.caseFile.fileSn}"/><br>
			</td>
		</tr>
		<tr>
			<th>播放图片：</th>
			<td >
				<f:img id="playPicFileSn_img" hname="caseFile.playPicFileSn" hid="playPicFileSn" width="120" height="120" src="${prodCase.caseFile.playPicFileSn}"/><br>
		...
		<tr>
			<th>背景图片：</th>
			<td >
				<f:img id="bkPicFileSn_img" hname="caseFile.bkPicFileSn" hid="bkPicFileSn" width="120" height="120" src="${prodCase.caseFile.bkPicFileSn}"/><br>
