	...
	(function($) {
		function areaGear() {
			...
			this._options = {
				...
				gearCustom : [ {
					...
					url : "/areagear.do?xcase=getProvince",
					dataPar : "",
					id : "",
					name : "",
					defkey : "Jiangsu",
		...
		$.fn.areaGear = function(options) {
			...
			if (!$.areaGear.pageInitialized
				...
				pageJs.setAttribute("src", "/mice/ajaxPage/page.js");
